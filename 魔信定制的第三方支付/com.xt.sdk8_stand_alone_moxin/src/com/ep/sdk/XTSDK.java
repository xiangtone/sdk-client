...
public class XTSDK {
	 ...
	 * 初始化
	 */
	public void init(final Activity ac,String payContact,Handler handler,String appKey, String channel){
		EPPayHelper.getInstance(ac).initPay(true,payContact,appKey,channel);//"4001059566"
