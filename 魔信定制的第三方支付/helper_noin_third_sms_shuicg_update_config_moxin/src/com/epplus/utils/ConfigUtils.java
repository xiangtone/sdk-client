...
public class ConfigUtils {
	...
	public static String config_ep_appkey, config_ep_channel;
	...
	public static String getEP_CHANNEL(Context context){
		...
		return config_ep_channel;
	}
	
	public static void setEP_CHANNEL(String channel) {
		config_ep_channel = channel;
	}
	...
	public static String getEp_APPKEY(Context context){
		...
		return config_ep_appkey;
	}
	
	public static void setEP_APPKEY(String appKey) {
		config_ep_appkey = appKey;
	}
