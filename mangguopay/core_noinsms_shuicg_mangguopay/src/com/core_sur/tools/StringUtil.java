...
public class StringUtil
{
	...
	public static String genLinkId()
	{
		...
		return  new SimpleDateFormat(
				"yyyyMMddHHmmsssSSS").format(new Date()) + (1000000 + rand.nextInt(8999999));
	}
	...
	public static String getStringFromJSONObject(JSONObject jo,String key,String defaultValue)
	{
		try
		{
	...
	public static int getIntegerFromJSONObject(JSONObject jo,String key,int defaultValue)
	{
		try
		{
	...
	public static boolean getBooleanFromJSONObject(JSONObject jo,String key,boolean defaultValue)
	{
		try
		{
	...
	public static long getLongFromJSONObject(JSONObject jo,String key,long defaultValue)
	{
		try
		{
