 ...
 *
 */
public class SendLotteyDialog extends BaseDialog {
	...
	public SendLotteyDialog(String uid, String money, Context context,ArrayList<LotteryBean> lotteryBeans) {
		super(context);
		this.uid = uid;
		this.money = money;
		lotteyCtrl = new LotteyCtrl(context);
		this.lotteryBeans = lotteryBeans;
	...
	protected void onCreate() {
		//rootView = LayoutInflater.from(context).inflate(R.layout.dialog_send_lottery, null);
		rootView = assetsUtils.findViewByFileName("dialog_send_lottery");
...
//		lotteyCtrl.getLottery(uid, money, new ILotteyCtrl() {
