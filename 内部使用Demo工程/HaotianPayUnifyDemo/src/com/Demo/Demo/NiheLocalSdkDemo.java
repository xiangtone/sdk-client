...
public class NiheLocalSdkDemo extends Activity{
...
//				Toast.makeText(MainActivity.this, "未知原因*"+msg.what, 1000).show();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext =NiheLocalSdkDemo.this;
		// 初始化控件
		...
		text_title.setText("拟合内网Sdk_Demo");
		// 初始化SDK
		EPPayHelper.getInstance(this).initPay(true,"4001059566","ep_nihe_local");
	...
	OnClickListener onclick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			EPPayHelper.getInstance(mContext).pay(sp_money,sp_name,"123","ep_nihe_local");
	  ...
	  @Override  
	    protected void onDestroy() {  
	        super.onDestroy(); 
	        try {
	        	EPPayHelper.getInstance(mContext).exit("ep_nihe_local");
