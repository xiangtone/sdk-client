...
public class NiheNetSdkDemo extends Activity{
...
//				Toast.makeText(MainActivity.this, "未知原因*"+msg.what, 1000).show();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		text_title.setText("拟合外网Sdk_Demo");
		// 初始化SDK
		EPPayHelper.getInstance(this).initPay(true,"4001059566","ep_nihe_net");
