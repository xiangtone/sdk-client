...
public class NormalNetSdkDemo extends Activity{
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 1070:
				Toast.makeText(mContext, "失败-"+msg.obj.toString(), 1000).show();
				break;
			case 1078:
				Toast.makeText(mContext, "失败*"+msg.what, 1000).show();
				break;
			case 4001:
			...
			case 4002:
				...
				break;
			case 4010:
				Toast.makeText(mContext, "初始化成功*"+msg.what, 1000).show();
				break;
			default:
//				Toast.makeText(MainActivity.this, "未知原因*"+msg.what, 1000).show();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext =NormalNetSdkDemo.this;
		// 初始化控件
		...
		text_title.setText("非拟合外网Sdk_Demo");
		// 初始化SDK
		EPPayHelper.getInstance(this).initPay(true,"4001059566","ep_normal_net");
	...
	OnClickListener onclick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			EPPayHelper.getInstance(mContext).pay(sp_money,sp_name,"123","ep_normal_net");
	  ...
	  @Override  
	    protected void onDestroy() {  
	        super.onDestroy(); 
	        try {
	        	EPPayHelper.getInstance(mContext).exit("ep_normal_net");
