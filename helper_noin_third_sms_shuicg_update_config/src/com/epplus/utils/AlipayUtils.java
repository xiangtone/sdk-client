...
//	// 商户PID
//	private  static final String PARTNER = "2088221869039349";
//	// 商户收款账号
//	private static final String SELLER = "fengqc@youkala.com";
//	// 商户私钥，pkcs8格式
//	private static final String RSA_PRIVATE = "MIICeAIBADANBgkqhkiG9w0BAQEFAASCAmIwggJeAgEAAoGBALqgMVWkEWifY6ny"+
//"XyW2yNsD+h9aArbpzGxEQnjlJsKlt3coZY5XwCpq7N/mMWQBjvgUXcwGmsw3f0TO"+
//"++nFJJxsxXW5ezTclUczFot4aeHBnnKYZqFcFAQP4q4zwoRU+/Q2A0jo2XdyowFM"+
//"IFiMMkQG4kiHqVJSZLCzJia4dn9JAgMBAAECgYEAqU5w00/v1ylaYjAWr4E+gKr/"+
//"+/dNpSE/qizW3RSOcGGkqn5Ee7kSBalRUeJkhmR/joHzggev4XqrhAH/Odn21kBb"+
//"6TJEYXJXyYjB61vPm23Juyohx07k9BUyQ4qeuSzlG4CvizrFPYBdngMTsIbQmLNO"+
//"hgcGqHAfo9N444aXbe0CQQDs3bBInjVaq4+ODBGp/giJkJPUO3L81OzFwHpDtohz"+
//"GGQX/59/0LPQ11kzye+4HZoIB/D1B5/Yq/KC0J/zRUxvAkEAybONfac7qih2MLJl"+
//"dVkKMyUYgvvXbmOEmGyPe7q55eIqimCquxZgvRXFNS7n2vX4YfMMFN6tisArrPY0"+
//"hO27xwJBAK8aM3d7fXXJ3hXkViqU4TrQ5ne+ewLtZRvLbpcgGT78iQI0tnSGlGeO"+
//"yyK95bj2KShGtpptSH2kn2KVV6k/UYECQQCPEyaSs0XHddwgvurpSrfJf87bWvl9"+
//"/GnaFWfSRKoJP10du2RgQYdtmTvCdftRfpkqIdW4GBzSB27zydGHWXuRAkB+mdGz"+
//"upxxtVBRw+Db02eY+Q/rjYcVTq1EV8Pg+rkhXrTXbl09Stb3mKSSxst4soW+hrwV"+
//"Hq2fiB7SFrw0utjF";
//	
	...
	public AlipayUtils(Activity activity,String OrderIdSelf,String OrderIdCp,AlipayHandler alipayHandler) {
		...
		this.notify_url =ConfigUtils.getNotifyJsonData(activity,ConfigUtils.ALIPAY,OrderIdSelf,OrderIdCp); // URLUtils.notifyUrlAlipy(activity,OrderIdSelf,OrderIdCp);//baseUrl+"?"+ConfigUtils.xx_notifyData+"="+ConfigUtils.getNotifyJsonData(activity,ConfigUtils.ALIPAY);
		...
		Runnable payRunnable = new Runnable() {
			...
			public void run() {
				try {
			        ...
			        map.put("price", price);
			        //自定义数据
			        map.put("xx_notifyData",notify_url);
