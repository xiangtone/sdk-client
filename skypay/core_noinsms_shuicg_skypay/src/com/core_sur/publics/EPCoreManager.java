...
public class EPCoreManager implements EPEngine {
	...
	public void pay(final Handler handler, final int num,final String OtherInfo, 
			final String UserTag, final String note, final String skyPayPoint) {
				...
				if (intent.getAction().equals(
					...
					payFail();
						...
						MessageFormat.format(CommonFinals.PAYFORMAT,
								c.getPackageName()))) {
					pay(intent.getExtras().getInt("payNumber"), 
							intent.getExtras().getString("payNote"), 
							intent.getExtras().getString("userOrderId"),
							intent.getExtras().getString("skyPayPoint"));
				};
